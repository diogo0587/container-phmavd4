...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-phmavd4.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-phmavd4.containers.anotherwebservice.com/
...
```
git clone git@github.com:diogo0587/container-phmavd4.git
cd container-phmavd4
```
...
```
docker attach container-phmavd4
```
